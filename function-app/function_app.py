...
def my_orchestrator(context: df.DurableOrchestrationContext):
    ...
    result = yield context.call_activity("validate_activity", order)
...
def report_activity(order: dict) -> str:
    ...
    # Poll until Succeeded or Failed (5-minute max)
    for _ in range(60):
    ...
    # Clean up the container group so it doesn't linger as a visible resource
